...
<section class="contact_area">
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-12">
				<form class="row contact_form" action="/blog/user?cmd=update" method="post" onsubmit="return vaildateCheck()">
					<input type="hidden" name = "id" value = "${sessionScope.user.id}" />
					<input type="hidden" name = "profile" value = "${sessionScope.user.userProfile}" />
					<div class="col-md-12">
					...
					<div class="col-md-12">
						<div class="form-group">
							<input type="text" class="form-control" value = "${sessionScope.user.address }" id="roadFullAddr" name="address" placeholder="도로명 주소" required="required" readonly>
						</div>
					</div>
					<!-- 도로명 주소 끝 -->
