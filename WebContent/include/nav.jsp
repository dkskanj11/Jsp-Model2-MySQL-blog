			...
			<nav class="navbar navbar-expand-lg navbar-light">
				<div class="container box_1620">
					...
					<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
						...
						<li class="nav-item"><a class="nav-link" href="/blog/user/userProfileForm.jsp"><img style="width: 30px; height: 30px; margin-top: 8px; border-radius: 50%;" src="${sessionScope.user.userProfile}"></a></li>
						</c:if>
